...
# 예약정보
driver.find_element_by_name('r_name').send_keys('이주원')   
driver.find_element_by_name('r_hp').send_keys('01075777933')
driver.find_element_by_name('r_email').send_keys('tlgudlove@naver.com')
driver.find_element_by_name('r_jumin1').send_keys('850204')
